    ...
    <section id="home" className="pt-16 min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-['Inter','Segoe_UI',sans-serif] mb-6">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-[#E5F1FF]/80 dark:text-[#E5F1FF]/80 text-gray-600 mb-8 max-w-4xl mx-auto">
