        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {chartTypes.map((chart, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-white dark:bg-[#0E1B2A] border border-[#3E4C5E] dark:border-[#3E4C5E] border-gray-200 rounded-xl p-6 hover:shadow-xl hover:shadow-[#0074BD]/10 dark:hover:shadow-[#0074BD]/10 hover:shadow-blue-500/10 transform hover:scale-105 transition-all duration-300 cursor-pointer"
              >
                ...
                <h3 className="text-xl font-semibold font-['Inter','Segoe_UI',sans-serif] text-gray-900 dark:text-[#E5F1FF] mb-3">
                  {chart.title}
                </h3>
                
                <p className="text-gray-700 dark:text-[#E5F1FF] leading-relaxed">
                  {chart.description}
                </p>
              </div>
            );
